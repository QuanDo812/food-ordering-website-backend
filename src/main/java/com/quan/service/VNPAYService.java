...
import com.quan.config.VNPAYConfig;
...
public class VNPAYService {
    ...
    public String createOrder(HttpServletRequest request, int amount, Long orderId, String orderInfor, String urlReturn){
    ...
    public Map<String, String> getParamsFromRequest(HttpServletRequest request) {
        ...
        for (Map.Entry<String, String[]> entry : requestParams.entrySet()) {
            params.put(entry.getKey(), entry.getValue()[0]); // Lấy giá trị đầu tiên
        }
        return params;
    }
